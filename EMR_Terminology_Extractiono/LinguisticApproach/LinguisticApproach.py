...
if __name__ == "__main__":
    # emr_texts = []
    # with open("../Data/medicaldata.txt", "r", encoding="utf-8") as f:
    #     emr_texts = [line.strip() for line in f if line.strip()]
...
#     ["abdominal cavity", "vertebral column", "layers of muscle", "stomach", "small intestines", "large intestines", "liver", "gallbladder", "spleen", "pancreas", "kidneys"],
#     ["pelvic cavity", "bony pelvis", "urinary bladder", "organs of reproduction", "sigmoid colon", "rectum"],
#     ["spinal canal", "cranial cavity", "backbone", "spinal cord"]
# ]
